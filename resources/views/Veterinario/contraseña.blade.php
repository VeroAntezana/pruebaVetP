...
@section('title','Cambiar Contraceña')
      ...
      <div class="max-w-md mx-auto">
        ...
        <div class="divide-y divide-gray-200">
          <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
            <p class="font-bold text-center text-3xl">Cambiar Contraseña:</p>
           
<form class="mt-4" method="POST" action="{{route('veterinario.updateContraseña')}}">
    @csrf
    <input type="password" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Contraseña Nueva" id="password" name="password">
    @error('password')
    ...
    <button type="sudmit" class="rounded-md bg-black w-full text-lg text-white font-semibold p-2 my-3 hover:bg-gray-600">Confirmar</button>
</form>
          </div>
