...
<form class="mt-4" method="POST" action="{{route('veterinario.updateTratamiento', $tratamiento->id)}}">
@csrf
...
<label for="">Mascota</label>
    ...
    <button type="sudmit" class="rounded-md bg-blue-500 w-full text-lg text-white font-semibold p-2 my-3 hover:bg-green-600">Editar</button>
