...
@section('title','Registrar Especie')
...
<h1 class="text-3xl text-center font-bold">Registrar Especie</h1>

<form class="mt-4" method="POST" action="{{route('admin.storedespecie')}}">
    @csrf
