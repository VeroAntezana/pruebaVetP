...
@csrf
    ...
    <select name=periodo_id id=periodo_id class="form-control">
        <option value=""> -- escoja Periodo --</option>

    
        <?php $datosperiodo = $con->query("SELECT * FROM periodos"); while($periodos = mysqli_fetch_array($datosperiodo)){ ?>
            <option value="<?php echo  $periodos['id']; ?>"><?php echo  $periodos['inicio']; ?> - <?php echo  $periodos['fin']; ?></option>
    ...
    <select name=reserva_id id=reserva_id class="form-control">
        <option value=""> -- escoja Reservas --</option>

    
        <?php $datosreservas = $con->query("SELECT * FROM reservas"); while($reservas = mysqli_fetch_array($datosreservas)){ ?>
            <option value="<?php echo  $reservas['id']; ?>"><?php echo  $reservas['id']; ?> - <?php echo  $reservas['fecha']; ?></option>
