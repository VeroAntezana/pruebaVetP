<title>Gestionar Mascotas - Veterinaria</title>
 <!-- Tailwind CSS Link -->
 <link rel="stylesheet" 
...
<h1 class="text-3xl text-center font-bold">Gestionar Paciente:</h1>
...
<li class="mx-6">
  <a href="{{route('admin.listamascota')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Lista de Mascotas</a>
</li>

<li class="mx-6 my-6">
  <a href="{{route('admin.indexraza')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Raza</a>
</li>

<li class="my-6 mx-6">
  <a href="{{route('admin.indexespecie')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Especie</a>
</li>
