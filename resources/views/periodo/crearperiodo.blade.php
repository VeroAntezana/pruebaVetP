...
@section('title','Registrar Periodo')
...
<h1 class="text-3xl text-center font-bold">Registrar periodo</h1>

<form class="mt-4" method="POST" action="{{route('admin.storedperiodo')}}">
@csrf
                                               <div>
                <label class=" dark:text-gray-200" for="passwordConfirmation">Hora de inicio</label>
                <input id="inicio" name="inicio" type="time" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white">
    @error('inicio')
    ...
    @enderror
            ...
            <div>
                ...
                <input id="fin" name="fin" type="time" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white">
     @error('fin')
     <p class="border border-red-500 rounded-md bg-red-100 w-full text-red-600 p-2 my-2">{{ $message }}</p>
    @enderror
            </div>
