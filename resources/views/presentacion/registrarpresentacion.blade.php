...
@section('title','Registrar Presentacion')
...
<h1 class="text-3xl text-center font-bold">Registrar Presentacion</h1>

<form class="mt-4" method="POST" action="{{route('admin.storedpresentacion')}}">
    @csrf
