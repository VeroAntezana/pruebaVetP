...
<li class="mx-6 my-6">
  <a href="{{route('admin.indexcategoria')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Categoria</a>
</li>

<li class="my-6 mx-6">
  <a href="{{route('admin.indexpresentacion')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Presentacion</a>
</li>

<li class="my-6 mx-6">
  <a href="{{route('admin.indexmarca')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Marca</a>
</li>

<li class="my-6 mx-6">
  <a href="{{route('admin.indexlote')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Lote</a>
</li>
