 ...
 <title>Gestionar Reservas - Veterinaria</title>
 <!-- Tailwind CSS Link -->
 <link rel="stylesheet" 
...
<h1 class="text-3xl text-center font-bold">Gestionar Reservas:</h1>
...
<li class="mx-6">
  <a href="{{route('admin.listareserva')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Lista de Reservas</a>
</li>

<li class="mx-6 my-6">
  <a href="{{route('admin.indexficha')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">ficha</a>
</li>

<li class="my-6 mx-6">
  <a href="{{route('admin.indexperiodo')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">periodos</a>
</li>
