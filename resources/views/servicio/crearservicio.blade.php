...
<h1 class="text-3xl text-center font-bold">Registrar Servicio</h1>

<form class="mt-4" method="POST" action="{{route('admin.storedservicio')}}">
    @csrf
    ...
    <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Link de la Imagen" id="imagen" name="imagen">
     @error('imagen')
     <p class="border border-red-500 rounded-md bg-red-100 w-full text-red-600 p-2 my-2">{{ $message }}</p>
    @enderror
