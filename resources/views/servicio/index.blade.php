 ...
 <title>Gestionar Servicios - Veterinaria</title>
 <!-- Tailwind CSS Link -->
 <link rel="stylesheet" 
...
<h1 class="text-3xl text-center font-bold">Gestionar Servicios:</h1>
...
<li class="mx-6">
  <a href="{{route('admin.listaservicio')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Servicios</a>
</li>

<li class="mx-6 my-6">
  <a href="{{route('admin.indextratamiento')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Tratamientos</a>
</li>

<li class="my-6 mx-6">
  <a href="{{route('admin.indexvisita')}}" class="font-semibold border-2 border-green-700 py-2 px-4 rounded-md hover:bg-green-700 hover:text-white">Visitas</a>
</li>
